...
import PetInformation from "./Report/Information";
import PetLostRoot from "./Report/Root";
import PetIdentification from "./Report/Identification";
...
const PetReportForm = () => {
  ...
  const onCheckValidation = () => {
    if (activeStepNo == 1) {
      return !composeState.petType || !composeState.gender || photos.length < 1
        ? true
        : false;
    }
    if (activeStepNo == 2) {
